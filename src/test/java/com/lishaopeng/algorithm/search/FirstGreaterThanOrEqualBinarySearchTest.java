...
class FirstGreaterThanOrEqualBinarySearchTest {
    private BinarySearch<Integer> bsearch = new FirstGreaterThanOrEqualBinarySearch<>();
    ...
    @Test
    void testSearch17() {
        int found = bsearch.search(new Integer[] { 2, 4, 4, 5 }, 5);
